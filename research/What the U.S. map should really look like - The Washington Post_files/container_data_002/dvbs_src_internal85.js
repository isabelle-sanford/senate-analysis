...
function dv_onError(evt) {
    ...
    var globalScope = dv_getDVErrorGlobalScope(elm);
    if (globalScope) {
        globalScope.reportError('VerifyFailedToLoad', dv_getScriptSRC(elm));
    }
}
...
hasPassback:!1,tagAdTag:c,tagPassback:e}};return f(b)}function G(b,c,e,d,f,n,l,k,g,u,p,z){void 0==c.dvregion&&(c.dvregion=0);var r=dv_GetParam(m,"useragent");m=window._dv_win.$dvbs.CommonData;if(void 0!=m.BrowserId&&void 0!=m.BrowserVersion&&void 0!=m.BrowserIdFromUserAgent)var q={ID:m.BrowserId,version:m.BrowserVersion,ID_UA:m.BrowserIdFromUserAgent};else q=Q(r?decodeURIComponent(r):navigator.userAgent),m.BrowserId=q.ID,m.BrowserVersion=q.version,m.BrowserIdFromUserAgent=q.ID_UA;var h="";void 0!=
c.aUrl&&(h="&aUrl="+c.aUrl);var x="";try{d.depth=R(d);var w=S(d,e,q);if(w&&w.duration){var t="&dvp_strhd="+w.duration;t+="&dvpx_strhd="+w.duration}w&&w.url||(w=T(d));w&&w.url&&(h="&aUrl="+encodeURIComponent(w.url),x="&aUrlD="+w.depth);var y=d.depth+f;n&&d.depth--}catch(H){t=x=h=y=d.depth=""}a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var v=1;break a}}catch(H){}v=0}f=function(){function b(c){f++;var d=c.parent==c;return c.mraid||d?c.mraid:20>=f&&b(c.parent)}var c=window._dv_win||
window,f=0;try{return b(c)}catch(da){}}();var m=c.script.src;v="&ctx="+(dv_GetParam(m,"ctx")||"")+"&cmp="+(dv_GetParam(m,"cmp")||"")+"&plc="+(dv_GetParam(m,"plc")||"")+"&sid="+(dv_GetParam(m,"sid")||"")+"&advid="+(dv_GetParam(m,"advid")||"")+"&adsrv="+(dv_GetParam(m,"adsrv")||"")+"&unit="+(dv_GetParam(m,"unit")||"")+"&isdvvid="+(dv_GetParam(m,"isdvvid")||"")+"&uid="+c.uid+"&tagtype="+(dv_GetParam(m,"tagtype")||"")+"&adID="+(dv_GetParam(m,"adID")||"")+"&app="+(dv_GetParam(m,"app")||"")+"&sup="+(dv_GetParam(m,
"sup")||"")+"&isovv="+v+"&gmnpo="+(dv_GetParam(m,"gmnpo")||"")+"&crt="+(dv_GetParam(m,"crt")||"");"1"==dv_GetParam(m,"foie")&&(v+="&foie=1");f&&(v+="&ismraid=1");(f=dv_GetParam(m,"xff"))&&(v+="&xff="+f);(f=dv_GetParam(m,"vssd"))&&(v+="&vssd="+f);(f=dv_GetParam(m,"apifw"))&&(v+="&apifw="+f);(f=dv_GetParam(m,"vstvr"))&&(v+="&vstvr="+f);(f=dv_GetParam(m,"tvcp"))&&(v+="&tvcp="+f);p&&(v+="&dvp_sfr=1");z&&(v+="&dvp_sfe=1");t&&(v+=t);r&&(v+="&useragent="+r);q&&(v+="&brid="+q.ID+"&brver="+q.version+"&bridua="+
q.ID_UA);v+="&dup="+dv_GetParam(m,"dup");try{v+=dv_AppendIQPAParams(m)}catch(H){}(p=dv_GetParam(m,"turl"))&&(v+="&turl="+p);(p=dv_GetParam(m,"tagformat"))&&(v+="&tagformat="+p);v+=V();u=u?"&dvf=0":"";p=K("maple")?"&dvf=1":"";c=(window._dv_win.dv_config.verifyJSURL||c.protocol+"//"+(window._dv_win.dv_config.bsAddress||"rtb"+c.dvregion+".doubleverify.com")+"/verify.js")+"?jsCallback="+c.callbackName+"&jsTagObjCallback="+c.tagObjectCallbackName+"&num=6"+v+"&srcurlD="+d.depth+"&ssl="+c.ssl+u+p+"&refD="+
y+c.tagIntegrityFlag+c.tagHasPassbackFlag+"&htmlmsging="+(l?"1":"0");(d=dv_GetDynamicParams(m,"dvp").join("&"))&&(c+="&"+d);(d=dv_GetDynamicParams(m,"dvpx").join("&"))&&(c+="&"+d);if(!1===k||g)c=c+("&dvp_isBodyExistOnLoad="+(k?"1":"0"))+("&dvp_isOnHead="+(g?"1":"0"));e="srcurl="+encodeURIComponent(e);(k=W())&&(e+="&ancChain="+encodeURIComponent(k));k=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(k=2E3);if(g=dv_GetParam(m,"referrer"))g="&referrer="+g,c.length+g.length<=
k&&(c+=g);(g=dv_GetParam(m,"prr"))&&(c+="&prr="+g);(g=dv_GetParam(m,"iframe"))&&(c+="&iframe="+g);(g=dv_GetParam(m,"gdpr"))&&(c+="&gdpr="+g);(g=dv_GetParam(m,"gdpr_consent"))&&(c+="&gdpr_consent="+g);h.length+x.length+c.length<=k&&(c+=x,e+=h);(h=X())&&(c+="&m1="+h);(h=Y())&&0<h.f&&(c+="&bsig="+h.f,c+="&usig="+h.s);h=Z();0<h&&(c+="&hdsig="+h);navigator&&navigator.hardwareConcurrency&&(c+="&noc="+navigator.hardwareConcurrency);c+=aa();h=ba();c+="&vavbkt="+h.vdcd;c+="&lvvn="+h.vdcv;""!=h.err&&(c+="&dvp_idcerr="+
encodeURIComponent(h.err));"prerender"===window._dv_win.document.visibilityState&&(c+="&prndr=1");(m=dv_GetParam(m,"wrapperurl"))&&1E3>=m.length&&c.length+m.length<=k&&(c+="&wrapperurl="+m);c+="&"+b.getVersionParamName()+"="+b.getVersion();b="&eparams="+encodeURIComponent(B(e));c=c.length+b.length<=k?c+b:c+"&dvf=3";window.performance&&window.performance.mark&&window.performance.measure&&window.performance.getEntriesByName&&(window.performance.mark("dv_create_req_end"),window.performance.measure("dv_creqte_req",
"dv_create_req_start","dv_create_req_end"),(b=window.performance.getEntriesByName("dv_creqte_req"))&&0<b.length&&(c+="&dvp_exetime="+b[0].duration.toFixed(2)));return{isSev1:!1,url:c}}function V(){var b="";try{var c=window._dv_win.parent;b+="&chro="+(void 0===c.chrome?"0":"1");b+="&hist="+(c.history?c.history.length:"");b+="&winh="+c.innerHeight;b+="&winw="+c.innerWidth;b+="&wouh="+c.outerHeight;b+="&wouw="+c.outerWidth;c.screen&&(b+="&scah="+c.screen.availHeight,b+="&scaw="+c.screen.availWidth)}catch(e){}return b}
function ba(){var b=[],c=function(b){d(b,null!=b.AZSD,9);d(b,b.location.hostname!=b.encodeURIComponent(b.location.hostname),10);d(b,null!=b.cascadeWindowInfo,11);d(b,null!=b._rvz,32);d(b,null!=b.FO_DOMAIN,34);d(b,null!=b.va_subid,36);d(b,b._GPL&&b._GPL.baseCDN,40);d(b,e(b,"__twb__")&&e(b,"__twb_cb_"),43);d(b,null!=b.landingUrl&&null!=b.seList&&null!=b.parkingPPCTitleElements&&null!=b.allocation,45);d(b,e(b,"_rvz",function(b){return null!=b.publisher_subid}),46);d(b,null!=b.cacildsFunc&&null!=b.n_storesFromFs,
47);d(b,b._pcg&&b._pcg.GN_UniqueId,54);d(b,e(b,"__ad_rns_")&&e(b,"_$_"),64);d(b,null!=b.APP_LABEL_NAME_FULL_UC,71);d(b,null!=b._priam_adblock,81);d(b,b.supp_ads_host&&b.supp_ads_host_overridden,82);d(b,b.uti_xdmsg_manager&&b.uti_xdmsg_manager.cb,87);d(b,b.LogBundleData&&b.addIframe,91);d(b,b.xAdsXMLHelperId||b.xYKAffSubIdTag,95);d(b,b.__pmetag&&b.__pmetag.uid,98);d(b,b.CustomWLAdServer&&/(n\d{1,4}adserv)|(1ads|cccpmo|epommarket|epmads|adshost1)/.test(b.supp_ads_host_overridden),100)},e=function(b,
c,d){for(var e in b)if(-1<e.indexOf(c)&&(!d||d(b[e])))return!0;return!1},d=function(c,d,e){d&&-1==b.indexOf(e)&&b.push((c==window.top?-1:1)*e)};try{return function(){for(var b=window,d=0;10>d&&(c(b),b!=window.top);d++)try{b.parent.document&&(b=b.parent)}catch(l){break}}(),{vdcv:28,vdcd:b.join(","),err:void 0}}catch(f){return{vdcv:28,vdcd:"-999",err:f.message||"unknown"}}}function R(b){for(var c=0;10>c&&b!=window._dv_win.top;)c++,b=b.parent;return c}function S(b,c,e){try{var d;if(!(d=e.ID==$dvbs.Enums.BrowserId.IE)){if(b==
window._dv_win.top)var f=$dvbs.Enums.TrafficScenario.OnPage;else{e=b;try{for(var n=0;window._dv_win.top!=e&&10>=n;){var l=e.parent;if(!l.document)break;e=l;n++}}catch(U){}f=e==window._dv_win.top?$dvbs.Enums.TrafficScenario.SameDomain:$dvbs.Enums.TrafficScenario.CrossDomain}d=f!=$dvbs.Enums.TrafficScenario.CrossDomain}if(d)return null;b.performance&&b.performance.mark&&b.performance.mark("dv_str_html_start");if(c){var k=c.toString().match(/^(?:https?:\/\/)?[\w\-\.]+\/[a-zA-Z0-9]/gi);if(k&&0<k.length)return null}var g=
b.document;if(g&&g.referrer){var u=g.referrer.replace(/\//g,"\\/").replace(/\./g,"\\."),p=new RegExp('(?:w{0,4}=")?'+u+"[^&\"; %,'\\$\\\\\\|]+","gi");c=/banner|adprefs|safeframe|sandbox|sf\.html/gi;d=/^\w{0,4}="/gi;var z=I(g,"script","src",p,c,d);if(!z){var r=g.referrer;f="";var q=g.getElementsByTagName("script");if(q)for(l=0;!f&&l<q.length;){var h=q[l].innerHTML;if(h&&-1!=h.indexOf(r)){var x=h.match(p);f=J(x,c,d)}l++}(z=f)||(z=I(g,"a","href",p,c,d))}g=htmlUrl=z;a:{if(b.performance&&b.performance.mark&&
b.performance.measure&&b.performance.getEntriesByName){b.performance.mark("dv_str_html_end");b.performance.measure("dv_str_html","dv_str_html_start","dv_str_html_end");var w=b.performance.getEntriesByName("dv_str_html");if(w&&0<w.length){var t=w[0].duration.toFixed(2);break a}}t=null}return{url:g,depth:-1,duration:t}}}catch(U){}return null}function J(b,c,e){var d="";if(b&&0<b.length)for(var f=0;f<b.length;f++){var n=b[f];n.length>d.length&&null==n.match(c)&&0!=n.indexOf('src="')&&0!=n.indexOf('turl="')&&
(d=n.replace(e,""))}return d}function I(b,c,e,d,f,n){b=b.querySelectorAll(c+"["+e+'*="'+b.referrer+'"]');var l="";if(b)for(c=0;!l&&c<b.length;)l=b[c][e].match(d),l=J(l,f,n),c++;return l}function T(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var e,d=1,f=0;0<d&&100>f;){try{if(f++,e=c.shift(),d--,0<e.win.location.toString().length&&e.win!=b)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,
depth:e.depth-1}}catch(k){}var n=e.win.frames.length;for(var l=0;l<n;l++)c.push({win:e.win.frames[l],depth:e.depth+1}),d++}return{url:"",depth:""}}catch(k){return{url:"",depth:""}}}function W(){var b=window._dv_win[B("=@42E:@?")][B("2?46DE@C~C:8:?D")];if(b&&0<b.length){var c=[];c[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var e=0;e<b.length;e++)c[e+1]=b[e];return c.reverse().join(",")}return null}function B(b){new String;var c=new String,e;for(e=0;e<b.length;e++){var d=
b.charAt(e);var f="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(d);0<=f&&(d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((f+47)%94));c+=d}return c}function y(){return Math.floor(1E12*(Math.random()+""))}function Q(b){for(var c=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/|Edg/",verRegex:"(MSIE |rv:| Edge/|Edg/)"},
...
c[f].verRegex)break;b=b.match(new RegExp(c[f].verRegex+"[0-9]*"));null!=b&&(d=b[0].match(new RegExp(c[f].verRegex)),d=b[0].replace(d[0],""));break}c=ca();4==e&&(c=e);return{ID:c,version:c===e?d:"",ID_UA:e}}function ca(){try{if(null!=window._phantom||null!=window.callPhantom)return 99;if(document.documentElement.hasAttribute&&document.documentElement.hasAttribute("webdriver")||null!=window.domAutomation||null!=window.domAutomationController||null!=window._WEBDRIVER_ELEM_CACHE)return 98;if(void 0!=
...
var b=!1;try{var c=document.createElement("p");c.innerText=".";c.style="text-shadow: rgb(99, 116, 171) 20px -12px 2px";b=void 0!=c.style.textShadow}catch(e){}return(0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")||window.webkitAudioPannerNode&&window.webkitConvertPointFromNodeToPage)&&b&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(e){return 0}}function X(){try{var b=0,c=function(c,d){d&&32>c&&(b=(b|1<<c)>>>0)},e=function(b,c){return function(){return b.apply(c,
arguments)}},d="svg"===document.documentElement.nodeName.toLowerCase(),f=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):d?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},n=["Moz","O","ms","Webkit"],l=["moz","o","ms","webkit"],k={style:f("modernizr").style},g=function(b,c){function d(){g&&(delete k.style,delete k.modElem)}var e;for(e=["modernizr","tspan","samp"];!k.style&&
e.length;){var g=!0;k.modElem=f(e.shift());k.style=k.modElem.style}var l=b.length;for(e=0;e<l;e++){var p=b[e];~(""+p).indexOf("-")&&(p=cssToDOM(p));if(void 0!==k.style[p])return d(),"pfx"==c?p:!0}d();return!1},u=function(b,c,d){var f=b.charAt(0).toUpperCase()+b.slice(1),h=(b+" "+n.join(f+" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)return g(h,c);h=(b+" "+l.join(f+" ")+f).split(" ");for(var k in h)if(h[k]in c){if(!1===d)return h[k];b=c[h[k]];return"function"===typeof b?e(b,d||
c):b}return!1};c(0,!0);c(1,u("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,u("shapeOutside","content-box",!0));return b}catch(p){return 0}}function C(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(e){}return b}function Y(){try{var b=C(),c=0,e=0,d=function(b,d,f){f&&(c+=Math.pow(2,b),e+=Math.pow(2,d))},f=b.document;d(14,0,b.playerInstance&&f.querySelector('script[src*="ads-player.com"]'));d(14,1,(b.CustomWLAdServer||
b.DbcbdConfig)&&(a=f.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));d(15,2,b.zpz&&b.zpz.createPlayer);d(15,3,b.vdApp&&b.vdApp.createPlayer);d(15,4,f.querySelector('body>div[class="z-z-z"]'));d(16,5,b.xy_checksum&&b.place_player&&(b.logjwonready&&b.logContentPauseRequested||b.jwplayer));d(17,6,b==b.top&&""==f.title?(a=f.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);d(17,
7,f.querySelector('script[src*="sitewebvideo.com"]'));d(17,8,b.InitPage&&b.cef&&b.InitAd);d(17,9,b==b.top&&""==f.title?(a=f.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);d(17,10,b==b.top&&""==f.title&&b.InitAdPlayer?(a=f.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);d(17,11,null!=b.clickplayer&&null!=b.checkRdy2);d(19,12,b.instance&&b.inject&&
f.querySelector('path[id="cp-search-0"]'));d(20,13,function(){try{if(b.top==b&&0<b.document.getElementsByClassName("asu").length)for(var c=b.document.styleSheets,d=0;d<c.length;d++)for(var e=b.document.styleSheets[d].cssRules,f=0;f<e.length;f++)if("div.kk"==e[f].selectorText||"div.asu"==e[f].selectorText)return!0}catch(h){}}());a:{try{var n=null!=f.querySelector('div[id="kt_player"][hiegth]');break a}catch(p){}n=void 0}d(21,14,n);a:{try{var l=b.top==b&&null!=b.document.querySelector('div[id="asu"][class="kk"]');
break a}catch(p){}l=void 0}d(22,15,l);a:{try{var k=f.querySelector('object[data*="/VPAIDFlash.swf"]')&&f.querySelector('object[id*="vpaid_video_flash_tester_el"]')&&f.querySelector('div[id*="desktopSubModal"]');break a}catch(p){}k=void 0}d(25,16,k);var g=navigator.userAgent;if(g&&-1<g.indexOf("Android")&&-1<g.indexOf(" wv)")&&b==window.top){var u=f.querySelector('img[src*="dealsneartome.com"]')||(b.__cads__?!0:!1)||0<f.querySelectorAll('img[src*="/tracker?tag="]').length;d(28,17,u||!1)}return{f:c,
s:e}}catch(p){return null}}function Z(){try{var b=C(),c=0,e=b.document;b==window.top&&""==e.title&&!e.querySelector("meta[charset]")&&e.querySelector('div[style*="background-image: url("]')&&(e.querySelector('script[src*="j.pubcdn.net"]')||e.querySelector('span[class="ad-close"]'))&&(c+=Math.pow(2,6));return c}catch(d){return null}}function aa(){try{var b="&fcifrms="+window.top.length;window.history&&(b+="&brh="+window.history.length);var c=C(),e=c.document;if(c==window.top){b+="&fwc="+((c.FB?1:0)+
(c.twttr?2:0)+(c.outbrain?4:0)+(c._taboola?8:0));try{e.cookie&&(b+="&fcl="+e.cookie.length)}catch(d){}c.performance&&c.performance.timing&&0<c.performance.timing.domainLookupStart&&0<c.performance.timing.domainLookupEnd&&(b+="&flt="+(c.performance.timing.domainLookupEnd-c.performance.timing.domainLookupStart));e.querySelectorAll&&(b+="&fec="+e.querySelectorAll("*").length)}return b}catch(d){return""}}var t=function(){function b(b,c){var g=[];c&&f.forEach(function(b){var d=dv_GetParam(c,b);""!==d&&
null!==d&&g.push(["dvp_"+b,d].join("="))});var k=window&&window._dv_win||{};k=k.dv_config=k.dv_config||{};k=dv_getDVBSErrAddress(k);var n=[d,e].join("="),q=["dvp_cert",l[b]].join("=");b=["dvp_jsErrMsg",b].join("=");k+=["/verify.js?ctx=818052&cmp=1619415&dvp_isLostImp=1&ssl=1",n,q,b,g.join("&")].join("&");(new Image(1,1)).src="https://"+k}var c=!1,e,d,f=["ctx","cmp","plc","sid"],n=y(),l={VerifyLoadJSONPCallbackFailed:1,VerifyFailedToLoad:2},k={onResponse:function(d){c||b("VerifyLoadJSONPCallbackFailed",
d)}};k.reportError=b;k.isJSONPCalled=c;window._dv_win[n]={globalScopeVerifyErrorHandler:k};return{setVersionData:function(b,c){d=b;e=c},setIsJSONPCalled:function(b){c=b},getIsJSONPCalled:function(){return c},onLoad:dv_onResponse,onError:dv_onError,uniqueKey:n}}();this.createRequest=function(){window.performance&&window.performance.mark&&window.performance.mark("dv_create_req_start");var b=!1,c=window._dv_win,e=0,d=!1,f;try{for(f=0;10>=f;f++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=
c.parent,e++,b=!0;else{b=!1;break}else{0==f&&(b=!0);break}}catch(x){b=!1}a:{try{var n=c.$sf;break a}catch(x){}n=void 0}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(D(b)){a:{try{var l=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(x){}l=void 0}if(l&&!D(l)&&0==l.indexOf(b)){b=l;var k=!0}}d=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,
url:null};f=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();l=f.script;this.dv_script_obj=f;this.dv_script=l;window._dv_win.dvbsProcessed.push(f);window._dv_win._dvScripts.push(l);var g=l.src;this.dvOther=0;this.dvStep=1;var u=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():
y():y();f=window.parent.postMessage&&window.JSON;var p=!0,t=!1;if("0"==dv_GetParam(g,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)t=!0;if(f&&0==t)try{var r=E(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+u);p=A(r)}catch(x){}r={};try{t=/[\?&]([^&]*)=([^&#]*)/gi;for(var q=t.exec(g);null!=q;)"eparams"!==q[1]&&(r[q[1]]=q[2]),q=t.exec(g);var h=r}catch(x){h=r}h.perf=this.perf;h.uid=u;h.script=this.dv_script;h.callbackName="__verify_callback_"+
h.uid;h.tagObjectCallbackName="__tagObject_callback_"+h.uid;h.tagAdtag=null;h.tagPassback=null;h.tagIntegrityFlag="";h.tagHasPassbackFlag="";0==(null!=h.tagformat&&"2"==h.tagformat)&&(q=P(h.script),h.tagAdtag=q.tagAdTag,h.tagPassback=q.tagPassback,q.isBadImp?h.tagIntegrityFlag="&isbadimp=1":q.hasPassback&&(h.tagHasPassbackFlag="&tagpb=1"));(q=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&
!window.MSStream)?r="https:":(r=h.script.src,g="http:",u=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=r.match("^https")||"https"!=u&&"http"==u||(g="https:"),r=g);h.protocol=r;h.ssl="0";"https:"===h.protocol&&(h.ssl="1");r=h;(g=window._dv_win.dvRecoveryObj)?("2"!=r.tagformat&&(g=g[r.ctx]?g[r.ctx].RecoveryTagID:g._fallback_?g._fallback_.RecoveryTagID:1,1===g&&r.tagAdtag?document.write(r.tagAdtag):2===g&&r.tagPassback&&document.write(r.tagPassback)),r=!0):r=!1;if(r)return{isSev1:!0};
this.dvStep=2;O(h,q);l=l&&l.parentElement&&l.parentElement.tagName&&"HEAD"===l.parentElement.tagName;this.dvStep=3;return G(this,h,b,c,e,d,f,p,l,q,k,n)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");if(t)try{t.setVersionData(this.getVersionParamName(),this.getVersion()),c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body,t.onLoad,t.onError,t.uniqueKey):dv_sendScriptRequest(b,t.onLoad,t.onError,t.uniqueKey)}catch(p){c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):
dv_sendScriptRequest(b)}else c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b);try{if("1"!=dv_GetParam(b,"foie")){var e=M(this.dv_script_obj&&this.dv_script_obj.injScripts),d=E("about:blank");d.id=d.name;var f=d.id.replace("iframe_","");d.setAttribute&&d.setAttribute("data-dv-frm",f);A(d,this.dv_script);if(this.dv_script){var n=this.dv_script;a:{b=null;try{if(b=d.contentWindow){var l=b;break a}}catch(p){}try{if(b=window._dv_win.frames&&window._dv_win.frames[d.name]){l=
b;break a}}catch(p){}l=null}n.dvFrmWin=l}a:{var k;if(d&&(k=d.contentDocument||d.contentWindow&&d.contentWindow.document)){var g=k;break a}g=(k=window._dv_win.frames&&window._dv_win.frames[d.name]&&window._dv_win.frames[d.name].document)?k:null}if(g)g.open(),g.write(e);else{try{document.domain=document.domain}catch(p){}var u=encodeURIComponent(e.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));d.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+
u+"');})()"}}}catch(p){e=window._dv_win.dv_config=window._dv_win.dv_config||{},e=dv_getDVBSErrAddress(e),d=[this.getVersionParamName(),this.getVersion()].join("="),e+=["/verify.js?ctx=818052&cmp=1619415&dvp_cert=3&num=6",d].join("&"),dv_SendErrorImp(e,[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(p)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=G);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"134"}}
;
