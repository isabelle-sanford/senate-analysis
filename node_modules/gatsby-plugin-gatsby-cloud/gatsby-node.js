...
exports.onPostBuild = async ({
  ...
  for (const [pathname, page] of pages) {
    if (page.mode && page.mode !== `SSG`) {
      index++;
      batch[(0, _gatsbyCoreUtils.generateHtmlPath)(``, pathname)] = page.mode;
      batch[(0, _gatsbyCoreUtils.generatePageDataPath)(``, pathname)] = page.mode;
  ...
  await Promise.all([(0, _buildHeadersProgram.default)(pluginData, pluginOptions), (0, _createSiteConfig.default)(pluginData, pluginOptions), (0, _createRedirects.default)(pluginData, redirects, rewrites), (0, _copyFunctionsManifest.default)(pluginData)]);
};
...
exports.onPostBootstrap = async ({
  ...
  for (const file of fileNodes) {
    fileNodesEmitted = (0, _ipc.emitFileNodes)({
