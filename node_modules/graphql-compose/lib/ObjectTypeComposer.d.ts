...
import {
  ...
  ExtensionsDirective,
  DirectiveArgs,
} from 'graphql-compose/lib/utils/definitions';
import { ProjectionType } from 'graphql-compose/lib/utils/projection';
import { TypeDefinitionString, TypeAsString } from 'graphql-compose/lib/TypeMapper';
import {
...
import {
  ...
  NamedTypeComposer,
} from 'graphql-compose/lib/utils/typeHelpers';
import { ThunkComposer } from 'graphql-compose/lib/ThunkComposer';
...
import { TypeInPath } from 'graphql-compose/lib/utils/typeByPath';
import { SchemaPrinterOptions } from 'graphql-compose/lib/utils/schemaPrinter';
import { ToInputTypeOpts } from 'graphql-compose/lib/utils/toInputType';
