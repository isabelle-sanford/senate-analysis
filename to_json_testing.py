...
class Attributes(Base):
    ...
    RACE  = Column(Integer)
    AGE = Column(Integer)
    CENSUS2010POP = Column(Integer) # bigint goes up to 2 billion
    ESTIMATESBASE2010 = Column(Integer)
    POPESTIMATE2010 = Column(Integer)
    POPESTIMATE2011 = Column(Integer)
    POPESTIMATE2012 = Column(Integer)
    POPESTIMATE2013 = Column(Integer)
    POPESTIMATE2014 = Column(Integer)
    POPESTIMATE2015 = Column(Integer)
    POPESTIMATE2016 = Column(Integer)
    POPESTIMATE2017 = Column(Integer)
    POPESTIMATE2018 = Column(Integer)
    POPESTIMATE2019 = Column(Integer)
...
senate_rows = (
    ...
    .with_entities(Senate.index, 
        ...
        Senate.gender,
        Senate.race,
        Senate.religion) # leaving out term_up and assumed_office and born for now
    .all()
)
senate_cols = ['index', 'st', 'state', 'senator', 'party', 'population', 'gender', 'race', 'religion']
